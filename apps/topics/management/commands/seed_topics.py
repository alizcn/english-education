...
TOPICS = [
    {
        ...
        'explanation': (
            ...
            '3. TEKİL ŞAHIS (-s / -es / -ies) YAZIM KURALLARI\n'
            '• Çoğu fiile sadece -s: work → works, play → plays\n'
            '• -s / -ss / -sh / -ch / -x / -o ile bitenlere -es: go → goes, do → does, watch → watches, fix → fixes, miss → misses\n'
            '• Ünsüz + y ile bitenlerde y düşer, -ies eklenir: study → studies, try → tries, fly → flies\n'
            '• Ünlü + y ile bitenlerde değişiklik olmaz: play → plays, buy → buys\n'
            '• Düzensiz: have → has\n\n'
            'SIK GÖRÜLEN ZAMAN ZARFLARI\n'
            'always, usually, often, sometimes, rarely, never, every day, on Mondays, twice a week\n'
            '• Zarf genelde fiilden önce gelir: She often reads. / I never drink coffee.\n'
            '• "be" fiilinden sonra gelir: She is always late.\n\n'
            'STATE VERBS (Durum Fiilleri)\n'
            'like, love, hate, know, believe, understand, want, need, own, belong, seem, prefer gibi fiiller\n'
            'genelde Present Continuous\'ta değil Present Simple\'da kullanılır:\n'
            '    I am knowing him ❌ → I know him ✅\n\n'
            'İPUÇLARI\n'
            '• 3. tekil şahısta (he/she/it) fiile -s eklemeyi unutma.\n'
            '• Olumsuz ve soruda fiil YALIN hâlde kalır: She doesn\'t WORKS ❌ → She doesn\'t WORK ✅\n'
            '• Kısa cevaplar: Do you…? → Yes, I do. / No, I don\'t.   Does she…? → Yes, she does. / No, she doesn\'t.'
        ),
        'examples': [
    ...
    },
    {
        ...
        'explanation': (
            ...
            'now, right now, at the moment, currently, these days, today, this week, tonight\n\n'
            '-ING YAZIM KURALLARI\n'
            '• Fiil sonu -e ile bitiyorsa e düşer: make → making, write → writing, have → having\n'
            '• Tek heceli CVC (ünsüz-ünlü-ünsüz) bitişlerde son ünsüz çift yazılır: run → running, swim → swimming, sit → sitting\n'
            '• -ie ile biten fiillerde -ie düşer, -ying gelir: lie → lying, die → dying, tie → tying\n'
            '• -w, -x, -y ile bitenler çift yazılmaz: play → playing, fix → fixing\n\n'
            'STATE VERBS (Durağan Fiiller) — Continuous\'ta KULLANILMAZ\n'
            '• Düşünme/görüş: know, believe, understand, think (opinion), remember, forget, mean, agree\n'
            '• Duygu/tercih: like, love, hate, prefer, want, need, wish\n'
            '• Algılama: see, hear, smell, taste, sound\n'
            '• Sahiplik/durum: have (sahip olmak), own, belong, seem, appear, exist\n'
            '    I am knowing him ❌ → I know him ✅\n'
            '    I am loving this song ❌ → I love this song ✅ (reklam sloganları hariç!)\n'
            '• Bazı fiillerin iki anlamı olur — eylem anlamında continuous kullanılabilir:\n'
            '    I have a car. (sahip olmak — state)\n'
            '    I am having lunch. (yemek yemek — action) ✅\n'
            '    I think you are right. (düşünmek/görüş — state)\n'
            '    I am thinking about the problem. (kafa yormak — action) ✅\n\n'
            'İPUÇLARI\n'
            '• Kısa cevap: Are you…? → Yes, I am. / No, I\'m not.\n'
            '• "always" + continuous → tekrar eden rahatsız edici alışkanlığı vurgular: He is always complaining!'
        ),
        'examples': [
    ...
    },
    {
        ...
        'explanation': (
            ...
            'ANAHTAR KELİMELER\n'
            'just, already, yet, ever, never, since, for, so far, recently, lately, up to now, today, this week\n\n'
            'BEEN vs GONE (önemli ayrım!)\n'
            '• have/has BEEN to = gidip gelmiş, deneyim: I have been to Paris twice. (Paris\'e gidip gelmişim)\n'
            '• have/has GONE to = gitmiş, hâlâ orada: She has gone to Paris. (şu an Paris\'te)\n\n'
            'PRESENT PERFECT vs PAST SIMPLE\n'
            '• Şimdiyle bağlantı varsa / ne zaman olduğu önemsizse → Present Perfect:\n'
            '    I have lost my keys. (anahtarım hâlâ kayıp)\n'
            '• Belirli bir geçmiş zaman varsa → Past Simple:\n'
            '    I lost my keys yesterday. ✅  (I have lost my keys yesterday ❌)\n'
            '• Belirli geçmiş işaretleri: yesterday, in 2019, last week, two days ago, when I was young\n\n'
            'İPUÇLARI\n'
            '• "yet" olumsuz ve soruda, cümle sonunda: Have you finished yet? / I haven\'t finished yet.\n'
            '• "already" olumluda, fiilden önce: I have already eaten.\n'
            '• "just" = az önce: She has just left.\n'
            '• "for + süre" (for 5 years, for a long time); "since + başlangıç noktası" (since 2010, since Monday).\n'
            '• Kısa cevap: Have you…? → Yes, I have. / No, I haven\'t.'
        ),
        'examples': [
    ...
    },
    {
        ...
        'explanation': (
            ...
            '• Present Perfect "ne yaptım / kaç kez" sonucuna odaklanır: I have read three books this week.\n'
            '• Present Perfect Continuous "ne kadar süredir yapıyorum" sürecine odaklanır: I have been reading for two hours.\n'
            '• "How long…?" sorusu genelde PPC ile: How long have you been learning English?\n'
            '• "How many…?" sorusu Present Perfect ile: How many books have you read?\n\n'
            'DİKKAT — STATE VERBS!\n'
            'Durağan fiiller (be, know, have [sahip olmak], like, love, believe…) PPC\'de KULLANILMAZ.\n'
            'Bu fiillerle uzun süreli durum anlatırken Present Perfect kullan:\n'
            '    I have been knowing her for years ❌ → I have known her for years ✅\n'
            '    She has been being sick ❌ → She has been sick ✅'
        ),
        'examples': [
    ...
    },
    {
        ...
        'explanation': (
            ...
            'yesterday, last week, last year, two days ago, in 1990, this morning (bitmişse), when I was a child\n\n'
            '-ED YAZIM KURALLARI (DÜZENLİ FİİLLER)\n'
            '• Çoğu fiile -ed: work → worked, play → played\n'
            '• -e ile bitenlere sadece -d: live → lived, love → loved\n'
            '• Ünsüz + y ile bitenlerde y → -ied: study → studied, try → tried\n'
            '• Tek heceli CVC → son ünsüz çift yazılır: stop → stopped, plan → planned\n'
            '• -w, -x, -y ile bitenler çift yazılmaz: play → played, fix → fixed\n\n'
            'SIK KULLANILAN DÜZENSİZ FİİLLER (V1 → V2 → V3)\n'
            'go → went → gone · see → saw → seen · come → came → come\n'
            'have → had → had · do → did → done · make → made → made\n'
            'take → took → taken · give → gave → given · get → got → got/gotten\n'
            'say → said → said · think → thought → thought · know → knew → known\n'
            'eat → ate → eaten · write → wrote → written · read → read → read\n'
            'buy → bought → bought · bring → brought → brought · find → found → found\n'
            'leave → left → left · lose → lost → lost · run → ran → run · feel → felt → felt\n\n'
            'BE FİİLİ (was/were)\n'
            '• I / he / she / it → was\n'
            '• you / we / they → were\n'
            '• Soru: Was she tired? / Were you there?\n'
            '• Olumsuz: wasn\'t / weren\'t\n\n'
            'İPUÇLARI\n'
            '• Olumsuz ve soruda fiil YALIN hâlde kalır: She didn\'t WENT ❌ → She didn\'t GO ✅\n'
            '• Belirli geçmiş zaman işaretleri (ago, yesterday, last…) Present Perfect yerine Past Simple gerektirir.\n'
            '• Kısa cevap: Did you…? → Yes, I did. / No, I didn\'t.'
        ),
        'examples': [
    ...
    },
    {
        ...
        'explanation': (
            ...
            '• Past Continuous: süren arka plan eylemi\n'
            '• Past Simple: kısa, kesici eylem\n'
            '    I was watching TV (süren) when the phone rang (kesen).\n'
            '• "while" genelde Past Continuous ile, "when" Past Simple ile kullanılır:\n'
            '    While I was driving, I saw an accident.\n'
            '    When I arrived, she was cooking.\n\n'
            'DİKKAT — STATE VERBS!\n'
            'Durağan fiiller (know, believe, like, love, hate, understand, want, be sick vb.) genelde\n'
            'Past Continuous\'ta kullanılmaz — bunun yerine Past Simple kullan:\n'
            '    I was knowing her ❌ → I knew her ✅\n'
            '    She was being sick ❌ → She was sick ✅'
        ),
        'examples': [
    ...
    },
    {
        ...
        'explanation': (
            ...
            'BE ABLE TO (yetenek için alternatif)\n'
            '• Diğer zamanlarda yetenek göstermek için "be able to" kullanılır (can\'in zamanı yoktur!)\n'
            '    Gelecek: I will be able to speak English next year.\n'
            '    Present Perfect: She has been able to solve it.\n'
            '    Future + modal: You might be able to help.\n'
            '• Past tek seferlik başarı için "could" yerine "was/were able to" kullanılır:\n'
            '    The fire was dangerous but they were able to escape. ✅\n'
            '    (they could escape ❌ — belirli bir olayda başardık derken "could" tuhaf kaçar)\n'
            '• Ama algı fiilleriyle (see, hear, smell…) "could" kullanılabilir:\n'
            '    I could hear voices. ✅\n\n'
            'RESMÎLİK SIRASI (rica/izin)\n'
            'Can → Could → May → Would (az resmîden çok resmîye):\n'
            '    Can you help me? (samimi) / Could you help me? (kibar) / Would you help me? (çok kibar)\n\n'
            'İPUÇLARI\n'
            '• Modaldan sonra fiil yalın kalır: She can WORKS ❌ → She can WORK ✅\n'
            '• Modalın past\'ı ya da üçüncü tekili yoktur: He cans ❌\n'
            '• "could have + V3" = geçmişte olması mümkündü ama olmadı: You could have called me.'
        ),
        'examples': [
    ...
    },
    {
        ...
        'explanation': (
            ...
            'MUST vs HAVE TO\n'
            '• must: konuşmacının hissettiği zorunluluk, kural, güçlü tavsiye\n'
            '• have to: dışarıdan gelen, nesnel zorunluluk (kural, program, otorite)\n'
            '    I must call my mother. (kendi hissim)\n'
            '    I have to wear a uniform at work. (kurum kuralı)\n'
            '• OLUMSUZDA FARK ÇOK ÖNEMLİ:\n'
            '    must not (mustn\'t) = YASAK → You mustn\'t smoke here. (yasaktır)\n'
            '    don\'t/doesn\'t have to = GEREKMİYOR → You don\'t have to come. (istersen gelmeyebilirsin)\n'
            '• must\'un geçmiş ve gelecek zamanı yoktur — onun yerine "have to":\n'
            '    Geçmiş: I had to work yesterday.\n'
            '    Gelecek: I will have to work tomorrow.\n\n'
            'MUST (mantıksal çıkarım) — BE TIRED vs BE TIRED\n'
            '• Present: He must be tired. (kesin, güçlü tahmin — "yorgun olmalı")\n'
            '• Geçmişte çıkarım: He must have been tired. ("yorgun olmuş olmalı")\n'
            '• Olumsuz mantıksal çıkarım için "can\'t" kullanılır: He can\'t be tired — he just slept. (mustn\'t değil!)\n\n'
            'SHOULD vs OUGHT TO vs HAD BETTER\n'
            '• should: standart tavsiye (You should eat less sugar.)\n'
            '• ought to: should ile eş anlamlı, biraz daha formal (You ought to apologize.)\n'
            '• had better ("-sen iyi edersin"): uyarı, kötü sonuç olabilir → You had better hurry (or we\'ll miss the bus).'
        ),
        'examples': [
    ...
    },
    {
        ...
        'explanation': (
            ...
            '• Past Continuous: was/were being + V3 → The house was being painted.\n'
            '• Present Perfect: has/have been + V3 → The door has been repaired.\n'
            '• Past Perfect: had been + V3 → The work had been finished.\n'
            '• Future (will): will be + V3 → The results will be announced.\n'
            '• Future (be going to): am/is/are going to be + V3 → The event is going to be cancelled.\n'
            '• Modal: can/should/must be + V3 → The problem can be solved.\n'
            '• Modal + perfect: should have been + V3 → It should have been done.\n\n'
            'ACTIVE → PASSIVE DÖNÜŞÜM\n'
            'Active: Shakespeare wrote Hamlet.\n'
            'Passive: Hamlet was written by Shakespeare.\n'
            '1. Active cümlenin nesnesi (Hamlet) → passive\'de özne.\n'
            '2. Fiil → "be" (zamanı korunur) + V3: wrote → was written.\n'
            '3. Active cümlenin öznesi (Shakespeare) → "by ..." ile sonda (önemliyse).\n\n'
            'GET PASSIVE (günlük konuşma)\n'
            '• "be" yerine "get" + V3 kullanılabilir — daha samimi:\n'
            '    My car got stolen. / He got fired yesterday.\n\n'
            'İPUÇLARI\n'
            '• Eylemi yapan önemliyse "by" ile belirtilir: The book was written by George Orwell.\n'
            '• Eylemi yapan genel/bilinmeyen/önemsizse "by" düşer: English is spoken here.\n'
            '• Geçişsiz fiiller (go, arrive, sleep, come, happen…) passive\'e çevrilmez.\n'
            '• İki nesneli fiillerde (give, send, tell, show) iki farklı passive mümkün:\n'
            '    He gave me a gift. → I was given a gift. / A gift was given to me.'
        ),
        'examples': [
    ...
    },
    {
        ...
        'explanation': (
            ...
            '• Yes/No sorusu: He asked if/whether + dönüştürülmüş cümle. (düz cümle yapısı!)\n'
            '    "Are you OK?" → He asked if I was OK.\n'
            '• Wh- sorusu: He asked + soru sözcüğü + dönüştürülmüş cümle. (YARDIMCI FİİL KALKAR!)\n'
            '    "Where do you live?" → He asked where I lived. (❌ asked where do I live)\n'
            '    "What time is it?" → He asked what time it was.\n'
            '• Emir/rica: told/asked/ordered + kişi + (not) to + V1\n'
            '    "Close the door." → He told me to close the door.\n'
            '    "Don\'t be late." → She told me not to be late.\n'
            '    "Please help me." → He asked me to help him.\n\n'
            'SAY vs TELL\n'
            '• say: NESNE ALMAZ (veya "to" ile alır) — He said he was tired. / He said to me…\n'
            '• tell: NESNE HEMEN SONRA GELİR — He told me he was tired. (❌ He told he was tired)\n'
            '• Kalıp ifadeler: tell the truth / tell a lie / tell a story / say hello\n\n'
            'İPUÇLARI\n'
            '• Geri kaymayabileceği durumlar:\n'
            '    - Evrensel gerçekler: He said the Earth revolves around the Sun.\n'
            '    - Aktarma fiili present\'sa: He says he is tired. → He says he is tired. (kayma yok)\n'
            '    - Durum hâlâ geçerliyse: She said she lives in Paris. (hâlâ Paris\'te yaşıyor)\n'
            '• Modal geri kaymaları: can→could, may→might, must→had to, will→would, shall→should\n'
            '• Geri kaymayan modallar: would, could, might, should, ought to (zaten past form)'
        ),
        'examples': [
    ...
    },
    {
        ...
        'explanation': (
            ...
            '• the same as: Her age is the same as mine.\n'
            '• less + sıfat + than → daha az (more\'un tersi): This book is less interesting than that one.\n'
            '• the least + sıfat: This is the least expensive option. (en az pahalı)\n\n'
            'YOĞUNLAŞTIRICILAR (intensifiers)\n'
            '• much / far / a lot + comparative = "çok daha": This is much better. / Far more useful.\n'
            '• a bit / a little / slightly + comparative = "biraz daha": It\'s a bit colder today.\n'
            '• by far + the superlative = "açık ara en…": She is by far the best player.\n\n'
            'İKİ ZIT SIFAT ("daha ve daha")\n'
            '• comparative + and + comparative = "giderek artan":\n'
            '    It is getting colder and colder. / He became more and more tired.\n'
            '• the + comparative…, the + comparative… = "ne kadar … o kadar":\n'
            '    The older you get, the wiser you become. (yaşlandıkça daha akıllı olursun)\n\n'
            'İPUÇLARI\n'
            '• Superlative\'den önce genellikle "the" gelir.\n'
            '• Hem -er hem more kullanma: more taller ❌ → taller ✅\n'
            '• "than" sonrası özne zamiri veya iyelik: He is taller than me. / …taller than I am. (her ikisi de kullanılır)\n'
            '• Düzensizler: good-better-best / bad-worse-worst / far-farther(mesafe)/further(derece)-farthest/furthest / little-less-least / much/many-more-most'
        ),
        'examples': [
